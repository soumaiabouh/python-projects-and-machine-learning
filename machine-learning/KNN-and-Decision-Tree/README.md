...
As part of this project, I contributed to the implementation and analysis of the Decision Tree algorithm. 
I also participated in the implementation and evaluation of the KNN algorithm. 
The project provided valuable experience in applying machine learning techniques to real-world problems and interpreting the results.
The repository includes the code, datasets, and a report summarizing the results of the analysis.
